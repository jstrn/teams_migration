...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/astral-sh/uv/releases/download/0.9.3',
...
if ($env:UV_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/astral-sh/uv/releases/download/0.9.3"
}
